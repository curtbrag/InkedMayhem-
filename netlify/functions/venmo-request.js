...
// src/functions/venmo-request.mts
var venmo_request_exports = {};
__export(venmo_request_exports, {
  config: () => config,
  default: () => venmo_request_default
});
module.exports = __toCommonJS(venmo_request_exports);
...
var venmo_request_default = async (req) => {
  ...
  try {
    ...
    let decoded;
    try {
      decoded = import_jsonwebtoken.default.verify(token, getSecret());
    } catch {
    ...
    await sendTelegramNotification(
      `\u{1F4B8} <b>Venmo Payment Pending</b>
